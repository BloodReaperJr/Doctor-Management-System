...
import com.amdocs.DMS.Exception.InvalidInputforAvailability;
import com.amdocs.DMS.Exception.InvalidInputforCountShift;
import com.amdocs.DMS.Exception.InvalidInputforDeleteException;
import com.amdocs.DMS.Exception.InvalidInputforUpdateFees;
...
public class DoctorFunctions 
{
	...
	static Connection con1 = dbConnect.getConnection();
	 ...
	 public static void deleteDoctor( int deleteID) throws InvalidInputforDeleteException 
	 {
		 if(deleteID <= 0)
		 {
			 throw new InvalidInputforDeleteException("Entered value is less than zero please enter value greater then zero");
		 }
	 ...
	 public static void searchDoctorsByAvailability( String checkShift) throws InvalidInputforAvailability
	 {
		 ...
		 {
			 throw new InvalidInputforAvailability("Invalid Value Entered");
		 }
	 ...
	 public static void CountDocShift( String countDocShift) throws InvalidInputforCountShift
	 {
		 ...
		 {
			 throw new InvalidInputforCountShift("Invalid Input");
		 }
		 String search = "Select * from DoctorInfo where availability = ?";
		 int Count=0;
		 try {
	 ...
	 public static void UpdateFees( int id , double docFees) throws InvalidInputforUpdateFees
	 {
		 ...
		 if(id<=0)
		 {
			 throw new InvalidInputforUpdateFees("Entered ID Value is less than zero");
		 }
		 else if(docFees <=0)
		 {
			 throw new InvalidInputforUpdateFees("Entered Fees Value is less than zero");
		 }
